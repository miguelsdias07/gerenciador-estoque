...
<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><h5>Editar Produto</h5></div>
            <div class="card-body">
                <form method="POST">
                    ...
                    <a href="produtos.php" class="btn btn-primary">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
...
<div class="row mt-4">
    <div class="col-md-4">
        <div class="card">
            <div class="card-header"><h5>Adicionar Produto</h5></div>
            <div class="card-body">
                <form method="POST">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header"><h5>Lista de Produtos</h5></div>
            <div class="card-body">
