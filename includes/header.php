    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-link" href="<?php echo $base_url; ?>/admin/produtos.php">Produtos</a>
                <?php if (isLoggedIn()): ?>
                    <a class="nav-link" href="<?php echo $base_url; ?>/admin/dashboard.php">Painel Admin</a>
                    <a class="nav-link" href="<?php echo $base_url; ?>/admin/categorias.php">Categorias</a>
                    <a class="nav-link" href="<?php echo $base_url; ?>/admin/usuarios.php">Usuários</a>
                    <a class="nav-link" href="<?php echo $base_url; ?>/admin/relatorios.php">Relatórios</a>
